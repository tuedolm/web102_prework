...
const unfundedGamesString = countUnfundedGames === 1 ? `1 game remains unfunded.` : `${countUnfundedGames} games remain unfunded.`;

// create a template string to display the information about the company
const displayString = `A total of $${GAMES_JSON.reduce( (total, game) => total + game.pledged, 0).toLocaleString()} has been raised for ${GAMES_JSON.length} games. ${unfundedGamesString} We need your help to fund these amazing games.`;
